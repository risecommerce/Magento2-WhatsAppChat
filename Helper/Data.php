...
namespace Risecommerce\WhatsAppChat\Helper;
...
use Magento\Framework\App\RequestInterface;
 ...
 /**
  * Class Data
  * @package Risecommerce\WhatsAppChat\Helper
  */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getWAIconUrl()
    {
        $whatsAppIcon = $this->scopeConfig
            ->getValue('wa_chat/general/risecommerce_whatsapp_chat_icon_upload', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);

        if (!$whatsAppIcon) {
            $params = ['_secure' => $this->request->isSecure()];
            return $this->assetRepo->getUrlWithParams('Risecommerce_WhatsAppChat::images/whatsapp-chat-button.png', $params);
        }

        return $this->getMediaUrl(). 'risecommerce/whatsapp_chat_image/'.$whatsAppIcon;
    }
